...
var lerp = function(x1,y1,x2,y2,f) {
...
var renderAst = function(o) {
	//The actual shape
	drawCircle(cx(o.x),cy(o.y),o.r*cs-slw,"#999999","#888888",slw);
...
var setupNetwork = function() {
	...
	socket.on("update",function(ps,pa,aa) {
...
var update = function() {
	...
	csr = (Date.now()-clientLast)/serverDelta;
	if (shaking) {
		updateShake();
	};
	//Draw background
